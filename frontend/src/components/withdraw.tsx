...
export function Withdraw() {
  ...
  const registryConfig = {
    address: registryAddress[chain?.id || 10200],
    abi: REGISTRY_ABI,
  };
            ...
            <div className="lane">
              {txPending !== '' && (
                <p className="message">
                  ...
                  <a
                    href={`https://blockscout.com/gnosis/chiado/tx/${txPending}`}
                    target="_blank"
                    rel="noreferrer"
                    className="link-text"
                  >
                    View on Gnosis Chiado Explorer{' '}
                    <FontAwesomeIcon
                      icon={faArrowRight}
                      transform={{ rotate: -45 }}
                    />
              ...
              {!!withdrawSuccess && (
                <p className="message">
                  ...
                  <a
                    href={`https://blockscout.com/gnosis/chiado/tx/${withdrawSuccess}`}
                    target="_blank"
                    rel="noreferrer"
                    className="link-text"
                  >
