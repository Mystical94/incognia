...
export function IncogniaID() {
  ...
  useEffect(() => {
    ...
    setMetaAddr('I' + base58.encode(addr));
  }, [spendingKey]);
  ...
  const handleCopy = useCallback(
    (e: React.MouseEvent<HTMLButtonElement>) => {
      e.stopPropagation();
      copyTextToClipboard(metaAddr ? `https://incognia/#${metaAddr}` : '').then(
        () => {
          setCopied(true);
          setTimeout(() => {
            setCopied(false);
  ...
  return (
    <div className="large-block incognia-pane ">
      <div className="incognia-pane-header">
        {opened ? (
          <div className="incognia-pane-header">
            <div className="header-item" style={{ alignItems: 'center' }}>
              <div className="header-item header-title">
                <h1>Your Incognia ID</h1>
              </div>
              <button
          ...
          <div className="incognia-pane-header">
            <div className="header-item" style={{ alignItems: 'center' }}>
              <div className="block-wide">
                ...
                <p className="label incognia-id-contracted">{metaAddr}</p>
              </div>
              <button
      ...
      <div
        className="incognia-pane-body"
        style={{ display: opened ? 'block' : 'none' }}
      >
        <p className="block">Share the Incognia ID to receive funds.</p>
        <div className="incognia-pane-header buttons">
          <div className="block-wide">
            <p className="label" style={{ textTransform: 'uppercase' }}>
              Incognia ID:
            </p>
            <p className="label incognia-id">{metaAddr}</p>
          </div>
        ...
        <div
          className="incognia-pane-header block message"
          style={{
            width: '90%',
