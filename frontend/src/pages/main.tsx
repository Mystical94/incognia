...
import { IncogniaID } from '../components/incogniaid';
...
export function Main() {
  ...
  const contractAddress = registryAddress[chain?.id || 10200];
      ...
      <div className="content">
        <div className="header-h">
          <div className="header-item">
            <img className="logo logo-bg" src={LogoHover} alt="Incognia" />
            <img
        ...
        <div className="promo large-block">
          ...
          <div className="benefits">
            ...
            <div className="item">
              ...
              <p>
                Send and receive {chain?.nativeCurrency.symbol || 'xDai'}{' '}
        ...
        <div className="footer">
          ...
          <a
            href={`https://blockscout.com/gnosis/chiado/address/${contractAddress}`}
            style={{ flexGrow: 1 }}
            target="_blank"
            rel="noreferrer"
          >
